...
class ModeloBlog extends mdl{
    ...
    private function crearTablas(){
        ...
        $prep = "CREATE TABLE IF NOT EXISTS blog(ID int(11) AUTO_INCREMENT, ";

        foreach(OPCIONES['db']['tablas']['blog']['campos'] as $key => $campo){

            $largo = isset($campo['long']) ? "(" . $campo['long'] . ") " : "" ;
            
            $prep .= $key . " " . $campo['tipo'] . $largo . $campo['null'] . ", ";
